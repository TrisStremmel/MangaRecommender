...
def recommend(userId: int, filters):
    ...
    userTable = []  # list of manga the user has rated (excludes filtered out manga)
    filteredRatings = []  # list of ratings for the manga they have rated (excludes filtered out manga)
    for i in range(len(convertedRatings)):
